---
title: "Onboarding SPA generated end-to-end by Microsoft Copilot Cowork"
...
tags:
  ...
  - "HTML/CSS/JS"
  - "Prompt Engineering"
metric: "~1 hour/day saved in new hire training"
team:
  - name: "Luis Cañadilla"
...
## 1. The Build Architecture (Zero Runtime AI)

> [!NOTE]
> The deployed app contains no runtime AI — the AI was used exclusively at build time to synthesize dense CRM documentation into a single static SPA. This was a deliberate choice for performance, offline capability, and zero server cost.
...
### Business Impact
- **~1 hour/day reduction in 1-on-1 training per new hire** (n=4, self-reported, first 3 months post-rollout).
- **21 interactive guides, 75 trackable subtasks** covering the full immigration & relocation workflow — from health insurance and housing to NIE card fingerprinting and *padrón* registration.
- **Built and published in under 2 weeks** using AI-assisted development with Copilot Cowork.
- **Still in active production** since May 2026 — the app is maintained as a living reference, updated as Spanish immigration regulation evolves.
...
By intelligently applying AI at build-time rather than runtime, we modernized our operations and proved the tangible ROI of AI adoption in the workplace without incurring recurring API costs. Instead of feeling overwhelmed, new hires found the onboarding process refreshing and self-driven, allowing our job specialists to pivot their focus back to high-value, strategic tasks.

Built with **Microsoft Copilot Cowork**. Source code and production artifacts are internal to IE University and not publicly available.
