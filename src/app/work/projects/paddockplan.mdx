...
*The interface utilizes a "Stealth Terminal" paradigm (JetBrains Mono, high contrast) mimicking F1 telemetry walls to build trust in the AI's precision.*
...
<div style={{ 
  ...
  <iframe 
    ...
    title="PaddockPlan Live Deployment"
  ></iframe>
</div>
