...
summary: "An integrated Generative AI platform that reduces Formula 1 Grand Prix logistical planning from weeks to seconds using Next.js Edge compute and strict JSON-mode LLM inference, with an Azure migration path for enterprise deployment."
team:
  - name: "Luis Cañadilla"
...
*Personal project — built outside the Microsoft stack to explore generative-UI patterns and strict-JSON LLM inference.*
